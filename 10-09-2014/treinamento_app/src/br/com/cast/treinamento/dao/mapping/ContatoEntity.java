...
public class ContatoEntity implements BaseColumns {
	...
	public static final String[] COLUNAS = { COLUNA_ID, COLUNA_NOME, COLUNA_ENDERECO, COLUNA_SITE, COLUNA_TELEFONE, COLUNA_AVALIACAO, COLUNA_FOTO };
	...
	public static Contato bindContato(Cursor cr) {
		...
		if (!cr.isBeforeFirst() || cr.moveToNext()) {
			...
			int indexFoto = cr.getColumnIndex(COLUNA_FOTO);
			if(!cr.isNull(indexFoto))
			{
				contato.setFoto(cr.getString(indexFoto));
			}
		}
